...
class BasicInformation(forms.Form):
    ...
    name = forms.CharField(required=True, widget=forms.TextInput(
        attrs={'class': 'org_manage_field'}))
    slogan = forms.CharField(required=True, widget=forms.TextInput(
        attrs={'class': 'org_manage_field'}))
    ...
    about = forms.CharField(widget=forms.Textarea(
        attrs={'class': 'org_manage_field'}), required=True)
...
class LinksAndSocialMedia(forms.Form):
    ...
    --------------------
        ...
        - Instragram
    """
    url0 = forms.URLField(required=False, widget=forms.URLInput(
        attrs={'class': 'org_manage_field'}))
    url1 = forms.URLField(required=False, widget=forms.URLInput(
        attrs={'class': 'org_manage_field'}))
    url2 = forms.URLField(required=False, widget=forms.URLInput(
        attrs={'class': 'org_manage_field'}))
    facebook = forms.URLField(required=False, widget=forms.URLInput(
        attrs={'class': 'org_manage_field'}))
    twitter = forms.URLField(required=False, widget=forms.URLInput(
        attrs={'class': 'org_manage_field'}))
    linkedin = forms.URLField(required=False, widget=forms.URLInput(
        attrs={'class': 'org_manage_field'}))
