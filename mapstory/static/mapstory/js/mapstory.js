...
(function() {
  ...
  .controller('createLayerModalCtrl', function($scope, $modalInstance, $http, modalImage, staticUrl) {
    ...
    $scope.geometryTypes = [{
      'label': 'Point',
      'value': 'com.vividsolutions.jts.geom.Point'
    }, {
      'label': 'Line',
    ...
    $scope.attributeTypes = [{
      ...
      'label': 'Date',
      'value': 'org.geotools.data.postgis.BigDate'
    }, ];
    ...
    $scope.setDefaultPermissions = function(edit) {
      ...
      if (edit === false) {
        $scope.layer.configuration_options.permissions = {
          ...
          'groups': {
            'registered': ['download_resourcebase', 'view_resourcebase']
          }
        };
      }
  ...
  .controller('featured_carousel', function($injector, $scope, $http) {
    ...
    function query_api(data) {
      return $http.get('/api/base/search/', {
        params: data || {}
    ...
    $scope.filterCategory = function(categoryFilter) {
      ...
      $scope.display = _.where($scope.results, {
