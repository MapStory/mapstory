...
exports.MapConfigTransformer = function(data) {
    ...
    var coord = [0, 0];
     ...
     var range = computeTicks(data.map.layers);
     var boxes = [];
     if (range.length) {

      var interval = 0, data2 = null;
        if (Array.isArray(range)) {
            data2 = range;
            totalRange = storytools.core.time.utils.computeRange(range);
        } else {
            interval = range.interval || storytools.core.time.utils.pickInterval(range);
            totalRange = range;
        }
        boxes = [{
                ...
                data: data2,
                start_time: totalRange.start,
                end_time: totalRange.end,
                center: coord,
                range: totalRange,
                speed: {
                    interval: interval,
         ...
         boxes = [{
                ...
                title: 'Chapter 2: ' + data.about.title,
                description: 'This is Chapter 2 of ' + data.about.abstract,
                data: null,
                start_time: -2335197600000,
                end_time: 1069286400000,
                center: ol.proj.transform([-0.12755, 51.507222], 'EPSG:4326', 'EPSG:3857'),
                range: new storytools.core.time.utils.Range(-2335197600000,1069286400000),//-1167588000000},//totalRange,
                speed: {
                    interval: moment.duration(1, 'years').asMilliseconds(),
                    seconds: 3
                }
...
},{"vis/node_modules/moment":3}],3:[function(require,module,exports){
//! moment.js
//! version : 2.10.3
